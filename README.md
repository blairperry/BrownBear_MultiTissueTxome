...
- Link to Rscript: [idConversionTables_10.20.21.R] (**ADD LINK**)
...
- Link to Rscript: [_OrthoLevelCountsAndNorms_01.13.22.R] (**ADD LINK**)
...
- Link to Rscript: [HousekeepingOGgroups_11.29.21.R] (**ADD LINK**)
...
- [DTUrtle_FilePrep_01.04.21.R] (**ADD LINK**) - prepare files and data for pairwise DTU analyses
- [AllTissues_dTurtle_02.04.21.R] (**ADD LINK**) - run all pairwise DTU analyses (this was run on Kamiak)
- [DTurtleResultParser.py] (**ADD LINK**) - used to parwse result files from above script into simpler format
- [dturtle_MultipleTissueResults_01.06.21.R] (**ADD LINK** ) - parsing and plotting DTU analysis results
...
- Link to Rscript: [TissueSpecificTranscripts_01.10.22.R] (**ADD LINK**)
...
- Link to Rscript: [Metabolism_CandGenes_04.25.22.R] (**ADD LINK**)